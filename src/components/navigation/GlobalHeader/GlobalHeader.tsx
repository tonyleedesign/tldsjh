  ...
  const logo = (
    <a href={logoHref} className="flex items-center h-(--space-24)">
      {logoSrc ? (
        ...
        <JudiLogo className="h-full w-auto" />
      )}
      {logoIconSrc && (
        <img
          src={logoIconSrc}
